...
namespace Elvex.Toolbox.Configuration.UnitTests
{
    ...
    public sealed class TemplatedConfigurationUnitTests
    {
        ...
        private const string TestFullStringName = "Elvex.Toolbox.Configuration.UnitTests.SampleFullConfiguration.json";
